...
public class ConnectBle {
    ...
    public ConnectBle(final Activity context, BluetoothDevice mDevice, IServiceDiscovered discovered) {
...
//            mContext.unregisterReceiver(receiver);
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    if(!connectDevice(device)){
                        Toast.makeText(mContext, R.string.toast_not_connected, Toast.LENGTH_SHORT).show();
                    }
    ...
    private boolean connectDevice(BluetoothDevice device) {
        ...
        try {
            ...
            serviceDiscoverDialog.createDialog(Constants.CONNECTING);
            isConnected = true;
    ...
    public void availableGattServices() {
        ...
        {
            Toast.makeText(mContext,R.string.toast_service_not_discovered,Toast.LENGTH_SHORT).show();
        }
